        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {projects.map((project) => (
              <div
                key={project.id}
                className="bg-[#151519] rounded-lg p-6 overflow-hidden group hover:shadow-[0_10px_30px_-10px_rgba(121,100,219,0.3)] transition-all duration-300 flex flex-col h-full"
              >
